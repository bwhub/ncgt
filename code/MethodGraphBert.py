...
class MethodGraphBert(BertPreTrainedModel):
    ...
    def forward(self, raw_features, wl_role_ids, init_pos_ids, hop_dis_ids, head_mask=None, residual_h=None):
        ...
        # print(f"raw_features is of type {type(raw_features)} shape {raw_features.shape}.")
        # print(f"wl_role_ids  is of type {type(wl_role_ids)} shape {wl_role_ids.shape}.")
        # print(f"init_pos_ids is of type {type(init_pos_ids)} shape {init_pos_ids.shape}.")
        # print(f"hop_dis_ids  is of type {type(hop_dis_ids)} shape {hop_dis_ids.shape}.")
