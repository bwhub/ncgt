...
class GraphBertConfig(PretrainedConfig):
    ...
    def __init__(
        ...
        max_hop_dis_index = 1000,
        max_inti_pos_index = 1000,
        hidden_size=32,
        num_hidden_layers=1,
        ...
        **kwargs
        ...
        # device used for training models, default 'cpu'
...
class BertEmbeddings(nn.Module):
    ...
    def __init__(self, config):
        ...
        # TODO: check if it is just using one-hot vectors?
    ...
    def forward(self, raw_features=None, wl_role_ids=None, init_pos_ids=None, hop_dis_ids=None):
        """Compute input embeddings for Graph-Transformer.
        """
        # Node Raw Feature Embedding 
        raw_feature_embeds = self.raw_feature_embeddings(raw_features)
        # Weisfeiler-Lehman Absolute Positional Embedding
        ...
        # Define the initial input vectors for nodes according to equation 6 in the paper.
        # The aggregation function used here is vector summation
        embeddings = raw_feature_embeds + role_embeddings + position_embeddings + hop_embeddings
        # CHECK: are the following two layers mentioned in the paper?
